## EXPERIMENT-05 4 BIT RIPPLE CARRY ADDER USING TASK AND 4 BIT RIPPLE COUNTER USING FUNCTION WITH TESTBENCH
...
```
## OUTPUT:
![image](https://github.com/user-attachments/assets/42f151a8-57c3-4901-8171-520d36885ed6)

## Verilog Code ripple counter adder using function:
```
...
```
## OUTPUT:
![image](https://github.com/user-attachments/assets/2e8b98bb-0e54-4388-8af0-36fe9abf61e0)
